...
client.on('ready', () => {
  console.log('켰다.');
  client.user.setPresence({ game: { name: '!help > 도움말' }, status: 'online' })
});
...
client.on('message', (message) => {
  ...
  if(message.content == '채팅공지') {
    ...
    let embed = new Discord.RichEmbed()
      .setTitle('GamChang LIFE 규칙!')
      .setAuthor('안내사항', img)
      .setThumbnail(img)
      .addBlankField()
      .addField('1. GamChang LIFE 채널은 다양한 게임의 친목 채널 입니다!', '롤, 마크, 배그, 옵치, 스팀, 에픽게임즈 등등 다양한 게임들의 정보를 나누고 여러 사람들과 같이 게임 해보세요.')
